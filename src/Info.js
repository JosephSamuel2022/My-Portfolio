...
const Info = () => {
  ...
  const handleDownloadResume = () => {
    ...
    anchor.href = '/Resume/Resume - Joseph Samuel M.pdf'; // Replace with the actual path to your resume file
  ...
  <a href={leetcodeURL} target="_blank" rel="noopener noreferrer" className="social-icon leetcode">
